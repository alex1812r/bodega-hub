-- Patch: create_purchase confia en montos REF+VES del frontend
-- Fecha: 2026-08-10
-- Requiere: 20260810b-purchase-ves-fields.sql (columnas VES)
--
-- El cliente debe enviar ambos lados (BS/VES y REF) ya calculados.
-- El RPC valida, persiste y actualiza stock/costos; no recalcula tasas ni impuestos.
--
