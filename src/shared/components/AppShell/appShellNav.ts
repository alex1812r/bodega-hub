...
export const appNavItems: AppNavItem[] = [
  ...
  { href: "/cash", icon: Wallet, label: "Mi caja", permission: "cash.operate" },
  { href: "/cash/registers", icon: Wallet, label: "Cajas", permission: "cash.manage" },
  { href: "/vault", icon: Landmark, label: "Baul", permission: "vault.view" },
  { href: "/payroll", icon: HandCoins, label: "Nomina", permission: "payroll.manage" },
  { href: "/payroll/mine", icon: HandCoins, label: "Mis recibos", permission: "payroll.view_own" },
