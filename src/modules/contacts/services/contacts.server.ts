...
const SUPPLIER_PRODUCT_SELECT = `
  *,
  product:products(
    id, sku, barcode, name, category_id, sale_price_ref, current_cost_ref, current_stock, min_stock, is_active, image_url,
    category:categories(id, name, tax_rate, description, is_active)
  ),
