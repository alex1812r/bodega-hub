...
type PosBarcodeScannerIconProps = {
  className?: string;
};

/** Material Symbols Outlined `barcode_scanner` (Stitch POS). */
export function PosBarcodeScannerIcon({ className }: PosBarcodeScannerIconProps) {
  return (
    <svg
      aria-hidden
